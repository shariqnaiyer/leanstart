...
pub static CLIENTS: &[ClientDef] = &[
    ...
    ClientDef {
        name: "ream",
        image: "ghcr.io/reamlabs/ream:latest-devnet3",
        arch_aware: false,
        seccomp_unconfined: false,
        hash_sig_mode: HashSigMode::None,
        has_http_port: true,
    ...
    ClientDef {
        name: "lantern",
        image: "piertwo/lantern:v0.0.3-test",
        arch_aware: true,
        seccomp_unconfined: false,
        hash_sig_mode: HashSigMode::Directory,
        has_http_port: true,
